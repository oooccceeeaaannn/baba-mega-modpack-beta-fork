	...
	for i,rules in ipairs(visualfeatures) do
		...
		if SPLITRULETYPES then
            for a, b in ipairs(tags) do
                if b == "textrule" then
                    color_pref = "$" .. rule_colouring.text .. "(t) " .. color_pref -- this is needed so that a rule generated by mimic will have the correct color
                elseif b == "logicrule" then
                    color_pref = "$" .. rule_colouring.logic .. "(l) " .. color_pref
                elseif b == "glyphrule" then
                    color_pref = "$" .. rule_colouring.glyph .. "(g) " .. color_pref
                elseif b == "noderule" then
                    color_pref = "$" .. rule_colouring.node .. "(n) " .. color_pref
                elseif b == "eventrule" then
                    color_pref = "$" .. rule_colouring.event .. "(e) " .. color_pref
                end
            end
        end
