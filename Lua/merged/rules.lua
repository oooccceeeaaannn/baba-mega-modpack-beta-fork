...
tense = { "present", "present", "present", "present", "present", "present", "present", "present", "pastprop", "pastprop", "pastprop", "pastprop", "pastprop", "pastprop", "pastprop", "pastprop", "future", "future", "future", "future", "future", "future", "future", "future", "pastprop", "pastprop", "pastprop", "pastprop", "pastprop", "future", "future", "future", "future", "future" }
					...
					for a,rules in ipairs(featureindex[target]) do
						...
						if (targetrule[1] == target) --@Merge: omg beeeeg if block
						  ...
						  and ((getmat(object) ~= nil) or is_str_special_prefixed(object) or (object == "level") or (object == "empty")
							  ...
							  or is_str_metalike_prop(object))
