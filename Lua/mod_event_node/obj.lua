...
for i,objobjname in pairs(objobjlist) do
	...
	local objobjactive = objobjactives[objobjname] or editor_objlist[editor_objlist_reference["text_" .. objobjname]].colour_active or {0,2}
